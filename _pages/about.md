...
- <font color=red>2025 年硕转博（面向本校研二同学）仍有名额（可与中科院自动化所联合培养），欢迎大家踊跃报名（guosen.xie@njust.edu.cn）！同时招收2026年学术博士，欢迎报考！</font>
...
<table align="center" border="none">
    <tr>
      <td style="padding-right: 15px;">
        <img align="left" width="330" height="240" src="/images/SDE.png" style="margin-right: 10px;"/>
      </td>
      <td>
        <p text-align="left">
    ...
    <tr>
      ...
      <td>
        <p text-align="left">
        X.-Y. Zhang, <b>G.-S. Xie</b>, X. Li, T. Mei, C.-L. Liu, A survey on learning to reject, Proceedings of the IEEE(<b>Proc. IEEE</b>), vol. 111, no. 2, pp. 185-215, 2023. (CCF A)
        </p>
      </td>
    </tr>
      <tr>
      ...
      <td>
        <p text-align="left">
        H. Xiong, L. Huang, W.J.T. Zang, X. Zhen, <b>G.-S. Xie</b>, B. Gu, L. Song, On the Number of Linear Regions of Convolutional Neural Networks With Piecewise Linear Activations, IEEE Transactions on Pattern Analysis and Machine Intelligence(<b>TPAMI</b>), vol. 46, no. 7, pp. 5131-5148, 2024. (CCF A)
        </p>
      </td>
    </tr>
</table>
